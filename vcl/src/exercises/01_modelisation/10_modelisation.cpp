...
#include "10_modelisation.hpp"

#ifdef INF443_10_MODELISATION
...
void scene_exercise::setup_palm_tree() {
	float angle = 0.8f;
	float r0 = 1.0f;
	float r2 = 2.0f;
...
void scene_exercise::draw_palm_tree(std::map<std::string,GLuint>& shaders, scene_structure& scene) {
