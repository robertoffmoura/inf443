...
#include "animated_interpolation_2.hpp"


#ifdef INF443_ANIMATED_INTERPOLATION_2
...
void scene_exercise::create_penguin() {
...
void scene_exercise::create_trajectory() {
    ...
    keyframe_position = {{0,0,0}, {3,0,0}, {3,0,3}, {6,0,3}, {9,0,3}, {9,0,0}, {12,0,0}, {12,0,-3}, {0,0,-3}, {0,0,0}, {3,0,0}, {3,0,3}};
